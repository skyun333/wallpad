...
def cryptoalgorithm_check(crypto):
    ...
    xcrypto =["DES","des","Des","double length Triple DES", "MD-5","md-5","Md-5","md5","Sha-1","sha1","sha-1","SHA-1","xor","Xor","XOR","Checksum", "checksum", "BASE64","Base64"]
    ...
    publickey = ["DH","Dh","dh","ECDH","Ecdh","ecdh","RSAES","Rsaes","rsaes"
    ,"RSA-PSS","RSA_PSS","RSA PSS","RSA-Pss","RSA-pss","RSA_Pss","RSA_pss","RSA Pss","RSA pss"
    ,"Rsa-PSS","Rsa_PSS","Rsa PSS","Rsa-Pss","Rsa-pss","Rsa_Pss","Rsa_pss","Rsa Pss","Rsa pss"
    ,"rsa-PSS","rsa_PSS","rsa PSS","rsa-Pss","rsa-pss","rsa_Pss","rsa_pss","rsa Pss","rsa pss"
    ,"KCDSA","Kcdsa","kcdsa","ECDSA","Ecdsa","ecdsa"
    ,"EC-KCDSA","EC_KCDSA","EC KCDSA","EC-Kcdsa","EC-kcdsa","EC_Kcdsa","EC_kcdsa","EC Kcdsa","EC kcdsa"
    ,"Ec-KCDSA","Ec_KCDSA","Ec KCDSA","Ec-Kcdsa","Ec-kcdsa","Ec_Kcdsa","Ec_kcdsa","Ec Kcdsa","Ec kcdsa"
    ,"ec-KCDSA","ec_KCDSA","ec KCDSA","ec-KCDSA","ec-kcdsa","ec_Kcdsa","ec_kcdsa","ec Kcdsa","ec kcdsa"]
    #symmetrickey -> 사용한 대칭키 알고리즘
    #symmetrickey = ["SEED","HIGHT","ARIA-128","ARIA-192","ARIA-256","LEA-128","LEA-192","LEA-256"]
    symmetrickey = ["SEED","Seed","seed","HIGHT","Hight","hight","ARIA-128","ARIA_128","ARIA 128","ARIA128"
    ,"Aria-128","Aria_128","Aria 128","Aria128"
    ,"aria-128","aria_128","aria 128","aria128"
    ,"ARIA-192","ARIA_192","ARIA 192","ARIA192"
    ,"Aria-192","Aria_192","Aria 192","Aria192"
    ,"aria-192","aria_192","aria 192","aria192"
    ,"ARIA-256","ARIA_256","ARIA 256","ARIA256"
    ,"Aria-256","Aria_256","Aria 256","Aria256"
    ,"aria-256","aria_256","aria 256","aria256"
    ,"LEA-128","LEA_128","LEA 128","LEA128"
    ,"Lea-128","Lea_128","Lea 128","Lea128"
    ,"lea-128","lea_128","lea 128","lea128"
    ,"LEA-192","LEA_192","LEA 192","LEA192"
    ,"Lea-192","Lea_192","Lea 192","Lea192"
    ,"lea-192","lea_192","lea 192","lea192"
    ,"LEA-256","LEA_256","LEA 256","LEA256"
    ,"Lea-256","Lea_256","Lea 256","Lea256"
    ,"lea-256","lea_256","lea 256","lea256"]
